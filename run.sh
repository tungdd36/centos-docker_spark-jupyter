NOTEBOOK_DIR=/home/tung/work/apache
docker run --name spark-master -h spark-master -e ENABLE_INIT_DAEMON=false -d -p 8888:8888 -v ${NOTEBOOK_DIR}:/notebook:z bde2020-centos/spark-master:2.4.4-hadoop2.7
